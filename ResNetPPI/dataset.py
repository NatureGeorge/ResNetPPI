...
# @Author: Zefeng Zhu
# @Last Modified: 2022-01-08 07:07:25 pm
...
class SeqStructDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        msa_file_2 = self.msa_dir/record.pdb_id/pdb_binary_int.chain_2.struct_asym_id/'t000_.msa0.a3m'
        ...
        loading_a3m_2 = load_pairwise_aln_from_a3m(msa_file_2)
        ref_seq_info_2 = next(loading_a3m_2)
        pw_msa_2 = sample_pairwise_aln(tuple(loading_a3m_2), self.max_k)
        iden_eff_weights_2 = get_eff_weights(pw_msa_2)[1:]
        pw_encodings_2 = tuple(add_hydro_encoding(onehot_encoding(pw_aln)) for pw_aln in pw_msa_2)
        iden_eff_weights_idx_2 = []
        pw_encodings_group_2 = tuple(gen_pw_encodings_group(pw_encodings_2, iden_eff_weights_idx_2))
        iden_eff_weights_2 = iden_eff_weights_2[iden_eff_weights_idx_2]
        
        return (
            (ref_seq_info_1, pw_encodings_group_1, iden_eff_weights_1, label_dist6d_1),
            (ref_seq_info_2, pw_encodings_group_2, iden_eff_weights_2, label_dist6d_2),
            label_dist6d_12
            )
